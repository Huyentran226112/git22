                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<?= ROOT_URL ?>admin<?php echo $row['image'];?>" alt="Image">
                        </div>
                ...
                <!-- bat đầu lặp  -->
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="<?= ROOT_URL ?>admin<?php echo $product['image'];?>" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href="<?= ROOT_URL ?>detail.php?id=<?php echo $row['id'];?>"><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="<?= ROOT_URL ?>detail.php?id=<?php echo $row['id'];?>"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
